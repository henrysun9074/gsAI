...
DARPAGEBV <- read.csv("/work/tfs3/gsAI/gebvs/sep05_GEBVs_10foldCV.csv") # Henry
DARPAGEBV2 <- read_xlsx("/work/tfs3/gsAI/4paul/CrossValDarpaGebv.xlsx") # Paul
...
```{r}
# df <- df %>%
#   rename(BayesB = BayesB_Mean, BRR = BRR_Mean, GBLUP = GBLUP_Mean, EGBLUP = EGBLUP_Mean, LASSO = LASSO_Mean, RKHS = RKHS_Mean)
write.csv(df, "/work/tfs3/gsAI/gebvs/sep08_GEBVs_10foldCV.csv", row.names = FALSE)
```
